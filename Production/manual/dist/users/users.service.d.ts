...
export declare class UsersService {
    ...
    update(id: number, nombres?: string, apellidoPaterno?: string, apellidoMaterno?: string, correoElectronico?: string, contrasena?: string, tipoCliente?: ClientType, estado?: ClientState): CreateUserDto;
